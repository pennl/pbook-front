		...
		<script>
			(function(){
				...
				var Util = (function(){
					...
					var prefix = 'fiction_reader_<?php echo $_GET['name'];?>';
				...
				function ReaderModel(){
					...
					var getSingleChapterInfo = function(chapter_id, callbackFun){
							//todo	
							<?php 
							echo "var url = \"https://back.pbook.xyz/get.php?start=\"+ chapter_id+\"&name=".$_GET['name']."\";";
?>
							//var url = 'https://back.pbook.xyz/get.php?start='+ chapter_id; 
							console.log(url);
							Util.getJSONP(url, callbackFun);
							//zhelibuzhidaozenmeban
							//console.log(data); 							
							//callbackFun(data); 
							// debugger;
					}
				...
				function ReaderBaseFrame(container){
					...
					function parseChapterData(data){
						...
						//var jsonObj = data;
						console.log(jsonObj);  
						var html = '<h4>' + jsonObj.t+'&nbsp;'+Chapter_id+'</h4>';
